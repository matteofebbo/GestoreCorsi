...
public class FXMLController {
    ...
    void corsiPerPeriodo(ActionEvent event) {
    	...
    	// se arriviamo a questo punto l' imput e' corretto
...
txtRisultato.clear();
    	...
    	if(!model.esisteCorso(codins)) {
    		txtRisultato.appendText("Corso insesistente\n");
    		return;
    	}
    ...
    void stampaStudenti(ActionEvent event) {
    	...
    	List<Studente> studenti= model.getStudentiByCorso(new Corso(codins,null,null,null));
